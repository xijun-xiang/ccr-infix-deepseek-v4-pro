...
- Caps `max_tokens` to a configurable safety limit. This branch defaults to `32768`.
...
- `maxOutputTokens`: caps oversized Claude Code `max_tokens` requests. The default is `32768`.
